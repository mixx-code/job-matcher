                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-red-50 border border-red-100 rounded-lg p-4">
                                <div className="flex items-center justify-between mb-2">
                                    <span className="font-semibold text-red-700">Jobs Ignored</span>
                                    <Badge count={filteringStats.jobs_ignored} style={{ backgroundColor: '#f5222d' }} />
                                </div>
                                <p className="text-sm text-gray-600">
                                    {filteringStats.jobs_ignored}  jobs were filtered out based on your preferences
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {filteringStats && Array.isArray(filteringStats.ignored_categories)
                                        ? filteringStats.ignored_categories.map((category, index) => (
                                            <span
                                                key={index}
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Tooltip title="8 jobs were filtered based on your preferences">
                                                <Badge count="8" style={{ backgroundColor: '#faad14', cursor: 'pointer' }} />
                                            </Tooltip>
                                        </div>
                                    </div>
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        <Tag color="blue" icon={<FireOutlined />}>AI-Powered</Tag>
                                        <Tag color="green" icon={<ThunderboltOutlined />}>Real-time</Tag>
                                        <Tag color="purple" icon={<StarOutlined />}>Personalized</Tag>
                                    </div>
                                </div>
