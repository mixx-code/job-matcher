...
type UserCVInsert = Database['public']['Tables']['user_cvs']['Insert'];
type UserCVUpdate = Database['public']['Tables']['user_cvs']['Update'];

interface FileInputProps {
    userId: string;
    file_name: string;
    onSuccess?: (data: UserCVRow) => void;
...
const FileInput: React.FC<FileInputProps> = ({ userId, file_name, onSuccess, existingRecordId }) => {
    ...
    const fetching = async (fileUrl: string, user_id: string): Promise<string | undefined> => {
